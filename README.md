...
> [!NOTE]   
> Por exemplo, a URL https://github.com/KetllynGuerrilla/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`KetllynGuerrilla`" para a contribuição no repositório `dio-lab-open-source`.
